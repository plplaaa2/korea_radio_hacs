...
- Restored `MediaClass.MUSIC` and aligned root to HA Official Radio Browser standards.
- Added `async_step_reconfigure` config flow for easier system adjustments.
